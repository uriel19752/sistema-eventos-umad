...
import { obtenerSolicitudes, obtenerSolicitudPorId, crearSolicitud, actualizarEstado, editarSolicitud, obtenerSolicitudPublica, asignarProveedores, exportarSolicitudPDF } from '../controllers/solicitud.controller.js'
