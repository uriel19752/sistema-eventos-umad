...
async function main() {
    ...
    const solCen03 = await prisma.solicitudEvento.create({
        data: {
            ...
            descripcion: "Evento cultural suspendido por fallas imprevistas de logistica.",
    ...
    await prisma.encuestaSatisfaccion.create({
        data: {
            ...
            atencionStaff: 5,
            satisfaccionGral: 5,
            comentarios: "La cobertura fotografica y la nota web se publicaron en tiempo record. Excelente servicio de marketing.",
        },
    });
    await prisma.encuestaSatisfaccion.create({
        data: {
            ...
            atencionStaff: 5,
            satisfaccionGral: 5,
            comentarios: "Muy buena atencion por parte del equipo tecnico, los banners digitales quedaron impecables.",
        },
    });
    await prisma.encuestaSatisfaccion.create({
        data: {
            ...
            atencionStaff: 5,
            satisfaccionGral: 5,
            comentarios: "La organizacion de la kermes estuvo impecable. Los asistentes quedaron muy satisfechos con la cobertura.",
        },
    });
    ...
    await prisma.encuestaSatisfaccion.create({
        data: {
            ...
            atencionStaff: 4,
            satisfaccionGral: 4,
            comentarios: "Buen despliegue, aunque el fotografo llego unos minutos tarde al partido inaugural.",
        },
    });
    await prisma.encuestaSatisfaccion.create({
        data: {
            ...
            atencionStaff: 3,
            satisfaccionGral: 3,
            comentarios: "Falto cobertura de redes sociales durante el cierre del evento gastronomico.",
        },
    });
    await prisma.encuestaSatisfaccion.create({
        data: {
            ...
            atencionStaff: 4,
            satisfaccionGral: 4,
            comentarios: "A pesar de la cancelacion, el equipo respondio rapido para notificar a los asistentes. Buen protocolo.",
        },
    });
